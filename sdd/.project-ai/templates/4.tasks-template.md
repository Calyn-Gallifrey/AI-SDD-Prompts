...
3. 不读取 `.project-ai/templates/code-review/代码评审统计报告模板_总.html`。
4. 不读取 `.project-ai/templates/code-review/个人代码评审报告模板.html`。
...
- Findings 模板：`.project-ai/templates/code-review/sdd-code-review-findings-template.md`
...
5. Process Status 生命周期、Phase Review 和验证方式记录必须遵守 `.project-ai/rules/process/SDD-Process-Control.md`。
